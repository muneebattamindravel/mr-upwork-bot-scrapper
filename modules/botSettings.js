...
async function getBotSettings(botId) {
  try {
    ...
    console.log(`calling `, ${process.env.BRAIN_BASE_URL}/bots/bot-settings/${botId})
    const response = await axios.get(`${process.env.BRAIN_BASE_URL}/bots/bot-settings/${botId}`);
